...
def SP22_13330_2016_Tab_A3():
    ...
    t2All = [
            ["32.00", 32.00, 24.00, 16.00, 10.00, 07.00, "7.00", "7.00", "7.00", "7.00", "7.00"],  # 0
            
            ["34.00", 34.0000, 27.0000, 22.00, 17.00, 14.00, 11.00, "11.00", "11.00", "11.00", "11.00"],  # 1
            ["32.00", 32.0000, 25.0000, 19.00, 14.00, 11.00, 08.00, "08.00", "08.00", "08.00", "08.00"],  # 2
            ["17.00", "17.00", "17.00", 17.00, 12.00, 08.00, 06.00, 05.0000, "5.000", "5.000", "5.000"],  # 3
            
            ["28.00", "28.00", 28.0000, 24.0000, 21.000, 18.00, 15.00, 12.00, "12.0", "12.0", "12.0"],  # 4
            ["21.00", "21.00", "21.00", 21.0000, 18.000, 15.00, 12.00, 09.00, "9.00", "9.00", "9.00"],  # 5
            ["15.00", "15.00", "15.00", "15.00", 15.000, 12.00, 09.00, 07.00, "7.00", "7.00", "7.00"],  # 6
            
            ["33.00", 33.0000, 24.0000, 17.0000, 11.000, 07.00, "7.0", "7.00", "7.0", "7.00", "7.00"],  # 7
            ...
            ["17.00", "17.00", "17.00", 17.0000, 13.000, 10.000, 07.000, "7.00", "7.00", "7.00", "7.00"],  # 10
...
def SP25_13330_2020_Tab_B8():
    ...
    Value_Sypesi_Nezasol_Yth = [
                    ...
                    ["--", "--", "--", "--", "--", "1.80", 1.80, 1.62, 1.45, 1.16, 0.81],
                    ["--", "--", "--", "--", "--", "--", "1.86", 1.86, 1.68, 1.45, 0.98],
                    ["--", "--", "--", "--", "--", "--", "--", "--", "--", "--", "--"]]
    ...
    Value_Sypesi_Nezasol_Yf = [
                    ...
                    ["--", "2.1", 2.10, "--", "--", "--", "--", "--", "--", "--", "--"],
                    ["--", "--", "2.02", 2.02, "--", "--", "--", "--", "--", "--", "--"],
                    ["--", "--", "--", "2.0", 2.00, 1.98, 1.84, 1.63, 1.35, 1.09, 0.73],
                    ["--", "--", "--", "--", "--", "2.00", 2.00, 1.78, 1.60, 1.29, 0.87],
    ...
    Value_Glins_Nezasol_Yth = [
                    ...
                    # ["--", "--", "--", "--", "--", "--", "1.57", 1.57, 1.39, 1.06, 0.70],

                    ["--", "--", "--", "--", "----", 1.68, 1.51, 1.33, 1.10, 0.87, 0.58],
    ...
    Value_Glins_Nezasol_Yf = [
                    ...
                    ["--", "1.90", 1.90, "--", "--", "--", "--", "--", "--", "--", "--"],
                    ["--", "--", "1.80", 1.80, "--", "--", "--", "--", "--", "--", "--"],
                    ["--", "--", "--", "1.76", 1.76, 1.65, 1.58, 1.31, 0.99, 0.77, 0.48],
    ...
    # -------------------------------------------------------------------------------------
    Value_Torfs_Yth = [
                    [0.810, 0.400, 0.230, 0.215, 0.120],
                    ["---", "0.810", 0.810, 0.520, 0.230],
                    ["---", "---", "0.930", 0.930, 0.410],
                    ["---", "---", "---", "0.930", 0.930]]
    
    Value_Torfs_Yf = [
                    [1.340, 0.700, 0.410, 0.320, 0.230],
                    ["---", "1.330", 1.330, 0.925, 0.520],
                    ["---", "---", "1.390", 1.390, 0.700],
                    ["---", "---", "---", "1.390", 1.390]]
    # -------------------------------------------------------------------------------------
